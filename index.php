...
<head>
  ...
  * Updated: Jul 22 2025 with Bootstrap v5.3.7
...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <h1 class="sitename" style="font-size:1.1em;">HPBPKI</h1>
      </a>
  ...
  <main class="main">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
            <div class="about-image">
              <img src="logo.png" alt="Logo HPBPKI" class="img-fluid">
            </div>
          </div>
        ...
        <div class="features-grid">
          <div class="features-card">
            ...
            <div class="image-container">
              <img src="https://bootstrapmade.com/content/demo/Devin/assets/img/illustration/illustration-14.webp" alt="Streamlined Workflow" class="img-fluid">
            </div>
          </div>
          ...
          <div class="features-card">
            ...
            <div class="image-container">
              <img src="https://bootstrapmade.com/content/demo/Devin/assets/img/illustration/illustration-6.webp" alt="Performance Analytics" class="img-fluid">
            </div>
          </div>
          ...
          <div class="features-card">
            ...
            <div class="image-container">
              <img src="https://bootstrapmade.com/content/demo/Devin/assets/img/illustration/illustration-7.webp" alt="Security Framework" class="img-fluid">
            </div>
          </div>
          ...
          <div class="features-card">
            ...
            <div class="image-container">
              <img src="https://bootstrapmade.com/content/demo/Devin/assets/img/illustration/illustration-8.webp" alt="Team Environment" class="img-fluid">
            </div>
          </div>
        </div>
        ...
        <div class="testimonial-slider swiper init-swiper">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <div class="testimonial-header">
                  <img src="https://bootstrapmade.com/content/demo/Devin/assets/img/person/person-f-12.webp" alt="Client" class="img-fluid" loading="lazy">
                  <div class="rating">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <div class="testimonial-header">
                  <img src="https://bootstrapmade.com/content/demo/Devin/assets/img/person/person-m-8.webp" alt="Client" class="img-fluid" loading="lazy">
                  <div class="rating">
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <div class="testimonial-header">
                  <img src="https://bootstrapmade.com/content/demo/Devin/assets/img/person/person-f-6.webp" alt="Client" class="img-fluid" loading="lazy">
                  <div class="rating">
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <div class="testimonial-header">
                  <img src="https://bootstrapmade.com/content/demo/Devin/assets/img/person/person-m-12.webp" alt="Client" class="img-fluid" loading="lazy">
                  <div class="rating">
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <div class="testimonial-header">
                  <img src="https://bootstrapmade.com/content/demo/Devin/assets/img/person/person-f-10.webp" alt="Client" class="img-fluid" loading="lazy">
                  <div class="rating">
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6">
            <div class="team-member d-flex">
              <div class="member-img">
                <img src="https://bootstrapmade.com/content/demo/Devin/assets/img/person/person-m-7.webp" class="img-fluid" alt="" loading="lazy">
              </div>
          ...
          <div class="col-lg-6">
            <div class="team-member d-flex">
              <div class="member-img">
                <img src="https://bootstrapmade.com/content/demo/Devin/assets/img/person/person-f-8.webp" class="img-fluid" alt="" loading="lazy">
              </div>
              <div class="member-info flex-grow-1">
                <h4>Sarah Jhonson</h4>
          ...
          <div class="col-lg-6">
            <div class="team-member d-flex">
              <div class="member-img">
                <img src="https://bootstrapmade.com/content/demo/Devin/assets/img/person/person-m-6.webp" class="img-fluid" alt="" loading="lazy">
              </div>
              <div class="member-info flex-grow-1">
          ...
          <div class="col-lg-6">
            <div class="team-member d-flex">
              <div class="member-img">
                <img src="https://bootstrapmade.com/content/demo/Devin/assets/img/person/person-f-4.webp" class="img-fluid" alt="" loading="lazy">
              </div>
              <div class="member-info flex-grow-1">
                <h4>Amanda Jepson</h4>
          ...
          <div class="col-lg-6">
            <div class="team-member d-flex">
              <div class="member-img">
                <img src="https://bootstrapmade.com/content/demo/Devin/assets/img/person/person-m-12.webp" class="img-fluid" alt="" loading="lazy">
              </div>
              <div class="member-info flex-grow-1">
                <h4>Brian Doe</h4>
                <span>Marketing</span>
          ...
          <div class="col-lg-6">
            <div class="team-member d-flex">
              <div class="member-img">
                <img src="https://bootstrapmade.com/content/demo/Devin/assets/img/person/person-f-9.webp" class="img-fluid" alt="" loading="lazy">
              </div>
              <div class="member-info flex-grow-1">
                <h4>Josepha Palas</h4>
                <span>Operation</span>
    ...
    <section id="contact" class="contact section">
      ...
      <div class="container section-title">
        <h2>Kontak</h2>
        <p>Hubungi HPBPKI untuk informasi lebih lanjut, keanggotaan, atau kerjasama.</p>
      </div><!-- End Section Title -->
          ...
          <div class="col-lg-7 order-lg-1 order-2">
            <div class="contact-form-container">
              <div class="form-intro">
                ...
                <p>Silakan isi formulir berikut untuk menghubungi kami. Kami akan segera merespon pertanyaan Anda.</p>
              </div>
              <form action="#" method="post" class="php-email-form contact-form">
                ...
                <div class="form-field message-field">
                  <textarea class="form-input message-input" name="message" id="userMessage" rows="5" placeholder="Pesan" required=""></textarea>
